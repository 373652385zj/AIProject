<template>
    <div class="test3">
        ...
        <div class="cont1">
            ...
            <br>
            <div class="father">
                <p style="font-size: 23px">IP地址</p>
                <p style="font-size: 23px">1.0</p>
                <br>
                <br>
                <br>
                <br>
                ...
                <br>
                <br>
                <p style="font-size: 23px">连接状态</p>
                <p style="color: #535353;font-size: 23px">未连接</p>
