<template>
    <div class="test3">
        ...
        <div class="cont1">
            ...
            <!----------------------------------------页面内部--------------------------------------------->
            <div class="father">
                <label style="width: 200px;font-size: 20px;">主服务器优先</label>
            </div>
            ...
            <br>
            <div class="father">
                <label style="width: 200px;font-size: 20px;">ss连接</label>
            </div>
            <div class="onoffswitch">
                <!--                <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch">-->
            ...
            <div class="father">
                ...
                <button v-on:click="save" value="Other"
                        style="margin-left: 393px;color: white;background-color: dodgerblue;outline: red">保存配置
                </button>
